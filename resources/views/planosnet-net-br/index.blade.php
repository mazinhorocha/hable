@extends('planosnet-net-br.layout.layout')
...
@section('content')
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach($produtos as $p)
                    @include('planosnet-net-br.layout.item',['produto'=>$p])
                @endforeach
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                @foreach($servicos as $srv)
                    @include('planosnet-net-br.layout.item2',['srv'=>$srv])
                @endforeach
            </div>
    ...
    @include('planosnet-net-br.layout.form-contato')

    @include('planosnet-net-br.layout.contato-mobile')
